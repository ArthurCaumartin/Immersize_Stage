...
namespace Entity.Weapons
{
    ...
    public class ScriptAbleWeaponData : ScriptableObject
    {
        ...
        // [SerializeField] protected float _rarityLevel;
        // [SerializeField] protected string _rarityName;
        ...
        // {
        //     _rarityName = RarityExtensions.Instance.GetByValue(_rarityLevel).ToString();
        // }
    }
}